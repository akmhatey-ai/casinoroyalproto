...
const HANDLER_MODULES: Record<string, () => Promise<{ GET?: Handler; POST?: Handler; PATCH?: Handler; PUT?: Handler; DELETE?: Handler; OPTIONS?: Handler }>> = {
  ...
  payments: () => import("@/lib/api/handlers/payments"),
  services: () => import("@/lib/api/handlers/services"),
  "services-id": () => import("@/lib/api/handlers/services-id"),
  "services-id-access": () => import("@/lib/api/handlers/services-id-access"),
  tickets: () => import("@/lib/api/handlers/tickets"),
  "tickets-create": () => import("@/lib/api/handlers/tickets-create"),
  "tickets-id": () => import("@/lib/api/handlers/tickets-id"),
  "tickets-id-comments": () => import("@/lib/api/handlers/tickets-id-comments"),
